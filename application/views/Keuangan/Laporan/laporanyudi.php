<a class="brand" href="<?php echo base_url()?>index.php/con_keuangan/laporanyud">Laporan Yudisium</a>
<div class="span6 pull-right">
    <?php echo form_open("con_keuangan/laporanyud", 'class="navbar-form pull-right"'); ?>
