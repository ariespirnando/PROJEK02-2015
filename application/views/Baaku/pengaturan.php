<a class="brand" href="<?php echo base_url()?>index.php/con_baaku/pengaturan">Pengaturan Password dan Username</a>
	</div>
    </div><!-- /navbar-inner -->
  </div><!-- /navbar -->
<div class="hero-unit">
<?php echo form_open('con_baaku/pengaturan','class="form-horizontal"'); ?>
