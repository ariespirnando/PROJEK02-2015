...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>SIPYuda :: Administrasi</title>
      ...
      <div class="navbar-inner">
        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              <li><a href="<?php echo base_url();?>index.php/con_keuangan"><i class="icon-home icon-white"></i> Home</a></li>
        <li class="dropdown">
                <a href="" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-book icon-white"></i> Master <b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li><a href="<?php echo base_url();?>index.php/con_keuangan/laporanwis"><i class="icon-tag"></i> Laporan Wisuda</a></li>
                  <li><a href="<?php echo base_url();?>index.php/con_keuangan/laporanyud"><i class="icon-tag"></i> Laporan Yudisium</a></li>
                  <li><a href="<?php echo base_url();?>index.php/con_toga"><i class="icon-tag"></i> Laporan Peminjaman Toga</a></li>
                </ul>
              </li>
            </ul>
        <div class="btn-group pull-right">
          ...
          <span class="caret"></span> Keuangan
          </button>
        <ul class="dropdown-menu">
        <li><a href="<?php echo base_url()?>index.php/con_login/logout"><i class="icon-off"></i> Log Out</a></li>
        <li><a href="<?php echo base_url();?>index.php/con_keuangan/pengaturan"><i class="icon-wrench"></i> Setting</a></li>
        </ul>
      </div>
          </div><!--/.nav-collapse -->
        </div>
