...
class graph
{
	...
	*/
	function graph()
	{
		...
		$this->width = 250;
		$this->height = 200;
		$this->js_path = base_url().'assets/js/js/';
		$this->swf_path = base_url().'assets/js/swf/';
		$this->x_labels = array();
		$this->y_min = '';
		$this->y_max = '';
		$this->x_min = '';
		...
		$this->lines = array();
		$this->line_default['type'] = 'bar';
		$this->line_default['values'] = '99,#87421F';
		$this->js_line_default = 'so.addVariable("bar","99,#87421F");';
